...
export interface BaalgroniSummonerInterface extends utils.Interface {
  ...
  events: {
    ...
    "SummonBaalgroniComplete(address,address,uint256,uint256,uint256,uint256,bytes)": EventFragment;
  };
...
export interface BaalgroniSummoner extends BaseContract {
  ...
  filters: {
    ...
    "SummonBaalgroniComplete(address,address,uint256,uint256,uint256,uint256,bytes)"(
      moloch?: null,
      wrapper?: null,
      price?: null,
      cap?: null,
