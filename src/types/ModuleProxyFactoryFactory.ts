...
import type { ModuleProxyFactory } from "./ModuleProxyFactory";

export class ModuleProxyFactoryFactory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<ModuleProxyFactory> {
  ...
  connect(signer: Signer): ModuleProxyFactoryFactory {
    return super.connect(signer) as ModuleProxyFactoryFactory;
  }
  static connect(
    address: string,
